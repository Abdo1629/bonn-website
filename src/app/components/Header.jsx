...
<Link href="/" className="text-2xl font-bold text-[#0056D2]">BONN</Link>
  ...
  {brandsOpen && (
    <motion.div
      ...
      className="absolute left-0 right-0 top-full z-40 bg-white/90 p-4 rounded-xl shadow-xl w-full"
    >
...
<button
  ...
  className="md:hidden text-gray-800 absolute top-4 right-4 z-50"
...
>
  <motion.div
    ...
    transition={{ duration: 0.3 }}
  >
    {isOpen ? <IoCloseSharp size={26} /> : <HiOutlineMenuAlt3 size={26} />}
  </motion.div>
</button>
