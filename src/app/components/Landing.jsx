...
export default function HeroVideo() {
  ...
  return (
    <div className="relative w-full h-[60vh] overflow-hidden mt-[65px]">
      <video
      ...
      <div className="relative z-20 h-full flex flex-col lg:flex-row items-center max-[768px]:justify-center px-6 gap-10 text-white">
    
        <motion.div
          className="w-full lg:w-1/2 max-[768px]:text-center"
        ...
        >
          <h4 className="text-base md:text-lg uppercase tracking-widest text-[#4ca1ff] font-semibold mb-[-11px] p-1">
            {isArabic ? "إطلالة جديدة بالكامل" : "A Whole New Look"}
          </h4>
